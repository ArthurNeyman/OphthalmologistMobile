      ...
      <View style={{ minHeight:130,maxHeight:200, justifyContent: 'center', alignItems: 'center', flexDirection: 'row', flex: 1 }}>
        ...
        <View style={{ flex: 5 }}>
          <View style={{ flex: 1, flexDirection: 'row' }}>
            <Text style={{flex: 25, color: "black", fontSize: 18, paddingTop: 13 }}>{item.lastName + " " + item.firstName + " " + item.surname}</Text>
            <View style={{padding: 10, alignItems: "center" }}>
              <Avatar style={{container:{backgroundColor:"white"}}} size={30} icon="person" iconColor="#00ADA8" />
            </View>
          </View>
